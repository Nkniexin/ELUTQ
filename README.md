...
CUDA_VISIBLE_DEVICES=0 python export_bcq.py \
 --resume_quant ./output/e2e-qp-output/Llama-3.1-8b-w2g128 \
 --wbits 2 --group_size 128 \
 --save_path ./output/bcqmodel-output/Llama-3.1-8b-w2g128

cd inference/GPU/bcqinference/custom_kernel
sudo do_install.sh

#change model to bcq type
cd /inference/GPU/bcqinference
python convert_to_bcqmodel.py --model_path ./output/bcqmodel-output/Llama-3.1-8b-w2g128 --output_dir ./Llama-3.1-8b-w2g128
