...
class HLQ:
    ...
    def fasterquant(
        ...
        for i1 in range(0, self.columns, groupsize):
            ...
            Q1, quantized1, scales1, zero_points1 = pseudo_quantize_tensor(W1,int(average_bit),True,groupsize,False,True,iters = iters,
        ...
        intweight = pack_bits(quantized_w)
        return intweight, w_scale, w_zero
